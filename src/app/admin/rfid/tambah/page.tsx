    ...
    <div className="space-y-6 w-full">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <button 
            onClick={() => router.back()} 
            className="p-1 rounded-lg hover:bg-neutral-100 transition-colors text-neutral-800"
            aria-label="Kembali"
          >
            <ArrowLeft className="w-6 h-6" />
          </button>
          <div>
            <h1 className="text-2xl font-bold text-neutral-900 leading-tight">Tambah RFID</h1>
