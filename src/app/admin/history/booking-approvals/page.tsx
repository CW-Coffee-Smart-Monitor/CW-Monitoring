...
export default function BookingApprovalsPage() {
  // const { t } = useLanguage();
  // const hc = t.bookingApprovalsPage;
  ...
  const PENDING_COUNT = allBookings.filter(
    (b) => b.status === "pending",
  ).length;
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-neutral-500 text-sm mt-1">
            Review and manage workspace requests requiring your authorization.
          </p>
        </div>
        ...
        {filtered.map((booking) => (
          ...
          >
            ...
            <div className="min-w-40">
              <p className="font-bold text-neutral-800">{booking.guestName}</p>
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg border border-neutral-300 text-neutral-700 text-sm font-semibold hover:bg-neutral-200 transition-colors shrink-0"
            >
              View Details
            </button>
          </div>
      ...
      {selectedBooking !== null && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          ...
          >
              ...
              <div className="w-56 shrink-0 space-y-4 pr-6 border-r border-neutral-100">
                ...
                <div className="bg-neutral-50 rounded-xl p-4 text-center space-y-2">
                  ...
                  <div className="pt-2">
                    ...
                    <p className="text-xs text-[#4B135F]">
                  ...
                  <div className="text-xs text-neutral-500 space-y-1 pt-1">
                    <div className="flex items-center justify-center gap-1.5">
                      ...
                      {selectedBooking.room ||
                        ...
                        (selectedBooking.blockCode
                          ? `Block ${selectedBooking.blockCode}`
                          : "Workspace Desk")}
                    </div>
              ...
              <div className="flex-1 pl-6 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-neutral-100 text-neutral-600 text-[10px] font-bold uppercase tracking-wide">
                        ...
                        {selectedBooking.branch || "Utama"}
                      </span>
                    </div>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="text-2xl font-bold text-[#4B135F]">
                  ...
                  <div className="bg-neutral-50 rounded-lg p-3">
                    ...
                    <div className="flex items-center gap-1.5 font-semibold text-neutral-800 text-sm">
                      ...
                      <span className="capitalize">
                        {selectedBooking.reservationScope} (
                ...
                <div className="rounded-xl overflow-hidden border border-neutral-200 bg-neutral-50">
                  ...
                  >
                    ...
                    {TABLE_POS.map((pos) => {
                      const isBooked =
                        pos.id === selectedBooking.tableId ||
                        selectedBooking.coveredTableIds?.includes(pos.id);
                      const isMainTable =
                        pos.id === selectedBooking.tableId ||
                        (selectedBooking.tableId == null &&
                          selectedBooking.coveredTableIds?.[0] === pos.id);
                      const w = pos.w ?? 63,
                        h = pos.h ?? 43;
                      const x = pos.x - w / 2,
                        y = pos.y - h / 2;
                              ...
                              return (
                                <>
                                  ...
                                  <text
                                    ...
                                    fontFamily="inherit"
                                  >
                                    {selectedBooking.guestName.split(" ")[0]} ·
                                    Seat #{pos.id}
                                  </text>
                                </>
                              );
            ...
            {/* Modal footer */}
            <div className="flex justify-end mt-2 mb-4 pr-6 border-neutral-200">
              {selectedBooking.status === "pending" ? (
                <div className="flex gap-2">
                  <button
                    type="button"
                    onClick={() => handleReject(selectedBooking.id)}
                    className="px-5 py-2.5 rounded-lg border border-red-200 text-sm font-semibold text-red-500 hover:bg-red-500 hover:text-white transition-colors"
                  >
                    Reject
                  </button>
                ...
                <>
                  {selectedBooking.status === "confirmed" && (
                    <span className="px-5 py-2.5 rounded-lg bg-green-100 text-green-700 text-sm font-semibold">
                      ✓ Approved
                    </span>
                  )}

                  {selectedBooking.status === "rejected" && (
                    <span className="px-5 py-2.5 rounded-lg bg-red-100 text-red-700 text-sm font-semibold">
                      ✕ Rejected
                    </span>
                  )}

                  {selectedBooking.status === "cancelled" && (
                    <span className="px-5 py-2.5 rounded-lg bg-neutral-200 text-neutral-700 text-sm font-semibold">
                      ⊘ Cancelled
                    </span>
                  )}
                </>
