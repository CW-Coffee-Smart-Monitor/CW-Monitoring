...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-neutral-800 bg-[#1A1A1A]/90 backdrop-blur-lg">
      <div className="mx-auto flex max-w-md items-center justify-between px-4 py-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-full border border-neutral-700 bg-neutral-800/60 px-3 py-1 text-[10px] font-medium text-neutral-300 transition-colors hover:border-amber-500/50"
        >
          {isSimulation ? (
            <>
              <motion.span
